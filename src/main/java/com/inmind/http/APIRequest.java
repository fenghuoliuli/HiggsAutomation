...
public class APIRequest {
	public static final org.apache.logging.log4j.Logger LOGGER = LogManager.getLogger(APIRequest.class.getName());
...
//	public static APIRequest PATCH(String uri)
//	{
//		return new APIRequest(uri, HttpMethod.PATCH);
//	}
	...
	public APIResponse invoke()
	{
		...
		client.register(new LoggingFeature(Logger.getLogger(APIResponse.class.getName())));		
